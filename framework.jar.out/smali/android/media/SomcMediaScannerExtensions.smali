...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "somctype"
...
.method fileMissing(Ljava/lang/String;J)V
    ...
    .line 95
    const-string/jumbo v1, "somctype"
    ...
    const-string/jumbo v3, "somctype=? AND filelinkpath=?"
...
.method postscan([Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "media_type=? AND _data LIKE ? AND somctype=?"
    ...
    const-string/jumbo v4, "media_type=? AND _data LIKE ?"
    ...
    const-string/jumbo v4, "media_type=? AND _data LIKE ? AND somctype=?"
    ...
    const-string/jumbo v5, "media_type=? AND somctype IN (?, ?)"
