...
.field private static final MEDIA_SCAN_ABORTED:I = -0x3
...
.field private mSomcExt:Landroid/media/SomcMediaScannerExtensions;
...
.method static synthetic access$1000(Landroid/media/MediaScanner;)Landroid/drm/DrmManagerClient;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1002(Landroid/media/MediaScanner;Landroid/drm/DrmManagerClient;)Landroid/drm/DrmManagerClient;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1200(Landroid/media/MediaScanner;)Landroid/media/MediaInserter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Landroid/media/MediaScanner;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private static addSlash(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .parameter "path"
...
.method private deletePlaylistIfModified(Landroid/net/Uri;)Z
    .locals 14
    ...
    sget-object v2, Landroid/media/MediaScanner;->PLAYLIST_MEMBERS_PROJECTION:[Ljava/lang/String;
    ...
    check-cast v9, Landroid/media/MediaScanner$PlaylistEntry;

    .line 1687
    .local v9, entry:Landroid/media/MediaScanner$PlaylistEntry;
    iget v0, v9, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchlevel:I
    ...
    iget-wide v2, v9, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchid:J
    ...
    .line 1683
    .end local v9           #entry:Landroid/media/MediaScanner$PlaylistEntry;
    .end local v10           #i:I
    ...
    .line 1688
    .restart local v9       #entry:Landroid/media/MediaScanner$PlaylistEntry;
    ...
    invoke-interface {v0, p1, v1, v2}, Landroid/content/IContentProvider;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_1
    ...
    const-string v1, "RemoteException in MediaScanner.deletePlaylistIfModified()"
...
.method private inScanDirectory(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Landroid/media/MediaScanner;->addSlash(Ljava/lang/String;)Ljava/lang/String;
...
.method private initialize(Ljava/lang/String;)V
    ...
    .line 1329
    new-instance v0, Landroid/media/SomcMediaScannerExtensions;

    iget-object v1, p0, Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/IContentProvider;

    invoke-direct {v0, v1, p1}, Landroid/media/SomcMediaScannerExtensions;-><init>(Landroid/content/IContentProvider;Ljava/lang/String;)V

    iput-object v0, p0, Landroid/media/MediaScanner;->mSomcExt:Landroid/media/SomcMediaScannerExtensions;
...
.method private postscan([Ljava/lang/String;)V
    ...
    .line 1304
    iget-object v0, p0, Landroid/media/MediaScanner;->mSomcExt:Landroid/media/SomcMediaScannerExtensions;

    invoke-virtual {v0, p1}, Landroid/media/SomcMediaScannerExtensions;->postscan([Ljava/lang/String;)V
...
.method private prescan(Ljava/lang/String;Z)V
    ...
    iget-object v8, v0, Landroid/media/MediaScanner;->mAudioUri:Landroid/net/Uri;
    ...
    const-string v8, "/albumart/check"
    ...
    iget-object v3, v0, Landroid/media/MediaScanner;->mSomcExt:Landroid/media/SomcMediaScannerExtensions;

    move-object/from16 v0, v28

    move-wide/from16 v1, v29

    invoke-virtual {v3, v0, v1, v2}, Landroid/media/SomcMediaScannerExtensions;->fileMissing(Ljava/lang/String;J)V
...
.method private processCachedPlaylist(Landroid/database/Cursor;Landroid/content/ContentValues;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, v7, v8, v0}, Landroid/media/MediaScanner;->matchEntries(JLjava/lang/String;)Z
    ...
    :cond_1
    invoke-direct {p0, p3}, Landroid/media/MediaScanner;->deletePlaylistIfModified(Landroid/net/Uri;)Z
    ...
    .line 1725
    .local v5, len:I
    new-instance v6, Landroid/media/MediaInserter;

    iget-object v9, p0, Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/IContentProvider;

    invoke-direct {v6, v9, v5}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;I)V

    .line 1726
    .local v6, mediaInserter:Landroid/media/MediaInserter;
    const/4 v4, 0x0
    ...
    iget v9, v2, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchlevel:I
    ...
    .line 1734
    invoke-virtual {v6, p3, p2}, Landroid/media/MediaInserter;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)V
    ...
    const-string v10, "RemoteException in MediaScanner.processCachedPlaylist()"
...
.method private processPlayLists()V
    ...
    .line 1936
    .restart local v7       #entry:Landroid/media/MediaScanner$FileEntry;
    :cond_1
    :try_start_1
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1349
    :try_start_0
    iget-boolean v9, p0, Landroid/media/MediaScanner;->mAbortScan:Z
    ...
    invoke-direct {p0, v9, v10}, Landroid/media/MediaScanner;->prescan(Ljava/lang/String;Z)V
    ...
    .line 1360
    .local v2, prescan:J
    new-instance v9, Landroid/media/MediaInserter;

    iget-object v10, p0, Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/IContentProvider;

    const/16 v11, 0x1f4

    invoke-direct {v9, v10, v11}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;I)V

    iput-object v9, p0, Landroid/media/MediaScanner;->mMediaInserter:Landroid/media/MediaInserter;

    .line 1363
    const/4 v4, 0x1

    .line 1364
    .local v4, runpostscan:Z
    const/4 v1, 0x0
    ...
    invoke-direct {p0, v9, v10}, Landroid/media/MediaScanner;->processDirectory(Ljava/lang/String;Landroid/media/MediaScannerClient;)I
    ...
    .line 1376
    :cond_1
    iget-object v9, p0, Landroid/media/MediaScanner;->mMediaInserter:Landroid/media/MediaInserter;
    ...
    const-string v10, "SQLException in MediaScanner.scan()"
    ...
    .restart local v4       #runpostscan:Z
    ...
    const-string v10, "UnsupportedOperationException in MediaScanner.scan()"
    ...
    const-string v10, "RemoteException in MediaScanner.scan()"
...
.method public scanMtpFile(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iput-boolean v2, v13, Landroid/media/MediaScanner$FileEntry;->mLastModifiedChanged:Z
