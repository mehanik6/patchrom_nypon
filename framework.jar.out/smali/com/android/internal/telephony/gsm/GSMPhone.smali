...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    .line 131
    const-string/jumbo v0, "persist.radio.eons.enabled"
...
.method private registerForSimRecordEvents()V
    ...
    invoke-virtual {v0, p0, v1, v2}, Lcom/android/internal/telephony/uicc/IccRecords;->registerForNewSms(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;I)Lcom/android/internal/telephony/Connection;
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v3, v2, v4, p2, p3}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;I)Lcom/android/internal/telephony/Connection;
    ...
    .line 768
    :cond_1
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isSpecialTemporaryModeCLIRCLIP()Z
...
.method public getDataConnectionState(Ljava/lang/String;)Lcom/android/internal/telephony/Phone$DataState;
    ...
    invoke-virtual {v1, p1}, Lcom/android/internal/telephony/DataConnectionTracker;->getState(Ljava/lang/String;)Lcom/android/internal/telephony/DataConnectionTracker$State;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v13, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCM:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/gsm/GSMPhone;->updateCallForwardStatus(I)V
    ...
    :goto_2
    invoke-virtual {v10, v14, v13}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZ)V
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSMS:Lcom/android/internal/telephony/SMSDispatcher;

    iget-object v13, v1, Landroid/os/AsyncResult;->result:Ljava/lang/Object;

    check-cast v13, Lcom/android/internal/telephony/gsm/SmsMessage;

    invoke-virtual {v14, v13}, Lcom/android/internal/telephony/SMSDispatcher;->dispatchMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    .local v4, eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    move-object/from16 v0, p1
    ...
    check-cast v13, Lcom/android/internal/telephony/uicc/SIMRecords;

    iget-object v14, v1, Landroid/os/AsyncResult;->result:Ljava/lang/Object;

    check-cast v14, Ljava/util/ArrayList;

    invoke-virtual {v13, v14}, Lcom/android/internal/telephony/uicc/SIMRecords;->getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    const-string v14, "getEonsForAvailableNetworks() aborted. icc absent?"
    ...
    const-string v14, "[EONS] Populated EONS for available networks."
    ...
    invoke-static {v9, v4, v13}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    .end local v4           #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    check-cast v4, Ljava/util/ArrayList;

    .restart local v4       #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    goto :goto_4
    ...
    const-string v14, "[EONS] In EVENT_GET_NETWORKS_DONE, onComplete is null!"
...
.method protected onUpdateIccAvailability()V
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSimCard:Lcom/android/internal/telephony/uicc/UiccCard;
...
.method public setCallBarringOption(Ljava/lang/String;ZLjava/lang/String;ILandroid/os/Message;)V
    .locals 6
    .parameter "facility"
    .parameter "lockState"
    .parameter "password"
...
.method public setNetworkSelection(Lcom/android/internal/telephony/OperatorInfo$SelectionMode;Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    .locals 5
    .parameter "mode"
    .parameter "network"
    .parameter "response"
    ...
    const-string v3, "setNetworkSelection2: wrapping and sending message to connect automatically"
    ...
    invoke-virtual {p2}, Lcom/android/internal/telephony/OperatorInfo;->getRAT()Lcom/android/internal/telephony/OperatorInfo$RAT;

    move-result-object v4

    invoke-interface {v2, v3, p1, v4, v0}, Lcom/android/internal/telephony/CommandsInterface;->setNetworkSelection(Ljava/lang/String;Lcom/android/internal/telephony/OperatorInfo$SelectionMode;Lcom/android/internal/telephony/OperatorInfo$RAT;Landroid/os/Message;)V
    ...
    const-string v3, "setNetworkSelection2: wrapping and sending message to connect manually"
...
.method public setNetworkSelection(Ljava/lang/String;Lcom/android/internal/telephony/OperatorInfo$SelectionMode;Lcom/android/internal/telephony/OperatorInfo$RAT;Landroid/os/Message;)V
    ...
    .local v0, msg:Landroid/os/Message;
    iput-object p4, v1, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;->message:Landroid/os/Message;
    ...
    const-string v3, "setNetworkSelection1: wrapping and sending message to connect automatically"
    ...
    invoke-interface {v2, p1, p2, p3, v0}, Lcom/android/internal/telephony/CommandsInterface;->setNetworkSelection(Ljava/lang/String;Lcom/android/internal/telephony/OperatorInfo$SelectionMode;Lcom/android/internal/telephony/OperatorInfo$RAT;Landroid/os/Message;)V
    ...
    const-string v3, "setNetworkSelection1: wrapping and sending message to connect manually"
