...
.method public isRecoveryPasswordSaved(Landroid/content/ComponentName;)Z
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->isRecoveryPasswordSaved(Landroid/content/ComponentName;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isSimplePasswordRestricted(Landroid/content/ComponentName;)Z
    .locals 3
    .parameter "admin"
    ...
    invoke-interface {v1, p1}, Landroid/app/admin/IDevicePolicyManager;->isSimplePasswordRestricted(Landroid/content/ComponentName;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public reportSuccessfulRecoveryPasswordAttempt()V
    ...
    invoke-interface {v1}, Landroid/app/admin/IDevicePolicyManager;->reportSuccessfulRecoveryPasswordAttempt()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public saveRecoveryPassword(Landroid/content/ComponentName;Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->saveRecoveryPassword(Landroid/content/ComponentName;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSimplePasswordRestricted(Landroid/content/ComponentName;Z)V
    .locals 3
    .parameter "admin"
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->setSimplePasswordRestricted(Landroid/content/ComponentName;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
