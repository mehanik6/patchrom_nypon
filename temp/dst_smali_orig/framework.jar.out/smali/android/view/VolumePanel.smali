...
.method public constructor <init>(Landroid/content/Context;Landroid/media/AudioService;)V
    ...
    iput v2, p0, Landroid/view/VolumePanel;->mLastStreamType:I

    iput v3, p0, Landroid/view/VolumePanel;->mLastFlags:I

    iput-boolean v3, p0, Landroid/view/VolumePanel;->mUseMasterVolume:Z
    ...
    iput-boolean v2, p0, Landroid/view/VolumePanel;->mUseMasterVolume:Z

    iget-boolean v2, p0, Landroid/view/VolumePanel;->mUseMasterVolume:Z
    ...
    .local v0, i:I
    :goto_0
    sget-object v2, Landroid/view/VolumePanel;->STREAMS:[Landroid/view/VolumePanel$StreamResources;
    ...
    iget v2, v1, Landroid/view/VolumePanel$StreamResources;->streamType:I
    ...
    :goto_1
    iput-boolean v2, v1, Landroid/view/VolumePanel$StreamResources;->show:Z
    ...
    .end local v0           #i:I
    .end local v1           #streamRes:Landroid/view/VolumePanel$StreamResources;
    :cond_1
    ...
    invoke-direct {p0}, Landroid/view/VolumePanel;->listenToRuntimeSkinChanged()V
...
.method private listenToRuntimeSkinChanged()V
    .locals 3
...
.method private reinflateUi()V
    ...
    :cond_0
    iput-object v2, p0, Landroid/view/VolumePanel;->mStreamControls:Ljava/util/HashMap;

    iput-object v2, p0, Landroid/view/VolumePanel;->mDialog:Landroid/app/Dialog;
