...
.field private static final PROPERTY_PROTECTED:Ljava/lang/String; = "Protected"
...
.method private declared-synchronized onSinkPropertyChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v8, "onSinkPropertyChanged: Address of the remote device in null"
    ...
    :cond_2
    :try_start_2
    iget-object v7, p0, Landroid/server/BluetoothA2dpService;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    .local v3, isA2dpSinkProtected:Z
    new-instance v2, Landroid/content/Intent;

    const-string v7, "com.sonyericsson.bluetooth.a2dp.action.SINK_PROPERTIES_CHANGED"

    invoke-direct {v2, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v2, intent:Landroid/content/Intent;
    const-string v7, "com.sonyericsson.bluetooth.a2dp.extra.SINK_SCMS_T_STATUS"
    ...
    const-string v8, "SEND INTENT SCMST SUPPORTED:"
    ...
    .end local v3           #isA2dpSinkProtected:Z
    :cond_3
    ...
    invoke-direct {p0, v7}, Landroid/server/BluetoothA2dpService;->convertBluezSinkStringToState(Ljava/lang/String;)I
    ...
    const-string v8, "A2DP: onSinkPropertyChanged newState is: "
    ...
    const-string v8, "mPlayingA2dpDevice: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Landroid/server/BluetoothA2dpService;->mPlayingA2dpDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {p0, v1, v7, v6}, Landroid/server/BluetoothA2dpService;->handleSinkStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    iput-object v7, p0, Landroid/server/BluetoothA2dpService;->mPlayingA2dpDevice:Landroid/bluetooth/BluetoothDevice;

    const/16 v7, 0xb

    const/16 v8, 0xa

    invoke-direct {p0, v1, v7, v8}, Landroid/server/BluetoothA2dpService;->handleSinkPlayingStateChange(Landroid/bluetooth/BluetoothDevice;II)V
