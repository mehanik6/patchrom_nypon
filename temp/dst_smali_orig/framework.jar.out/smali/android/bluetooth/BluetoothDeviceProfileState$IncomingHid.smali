...
.method public enter()V
    ...
    invoke-static {v2}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$11900(Landroid/bluetooth/BluetoothDeviceProfileState;)Landroid/os/Message;
    ...
    invoke-static {v0, v1}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$2200(Landroid/bluetooth/BluetoothDeviceProfileState;Ljava/lang/String;)V

    iget-object v0, p0, Landroid/bluetooth/BluetoothDeviceProfileState$IncomingHid;->this$0:Landroid/bluetooth/BluetoothDeviceProfileState;

    #calls: Landroid/bluetooth/BluetoothDeviceProfileState;->getCurrentMessage()Landroid/os/Message;
    invoke-static {v0}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$12000(Landroid/bluetooth/BluetoothDeviceProfileState;)Landroid/os/Message;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, p1}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$12100(Landroid/bluetooth/BluetoothDeviceProfileState;Landroid/os/Message;)V
    ...
    invoke-static {v4, v3}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$7102(Landroid/bluetooth/BluetoothDeviceProfileState;Z)Z
    ...
    #calls: Landroid/bluetooth/BluetoothDeviceProfileState;->deferMessage(Landroid/os/Message;)V
    invoke-static {v2, p1}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$12200(Landroid/bluetooth/BluetoothDeviceProfileState;Landroid/os/Message;)V
    ...
    invoke-static {v2, v4}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$12300(Landroid/bluetooth/BluetoothDeviceProfileState;Lcom/android/internal/util/IState;)V
