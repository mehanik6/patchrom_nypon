...
.method private native native_agps_set_ref_location_wifi(ILjava/lang/String;)V
.end method
...
.method private requestRefLocation(I)V
    ...
    .end local v9           #phone:Landroid/telephony/TelephonyManager;
    :cond_1
    :goto_1
    return-void
    ...
    .restart local v9       #phone:Landroid/telephony/TelephonyManager;
    :cond_2
    const/4 v1, 0x1
    ...
    .restart local v1       #type:I
    invoke-direct {p0, v1, v7}, Lcom/android/server/location/GpsLocationProvider;->native_agps_set_ref_location_wifi(ILjava/lang/String;)V
    ...
    const-string v4, "Scan did not start."

    invoke-static {v0, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    goto :goto_1

    .end local v10           #scanresult:Z
    .end local v12           #wifimanager:Landroid/net/wifi/WifiManager;
    :cond_8
    const-string v0, "GpsLocationProvider"

    const-string v4, "Unsupported Reference location flag requested."
