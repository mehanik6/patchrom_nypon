...
.method public static generatePackageInfo(Landroid/content/pm/PackageParser$Package;[IIJJLjava/util/HashSet;ZII)Landroid/content/pm/PackageInfo;
    ...
    iput v0, v13, Landroid/content/pm/PackageInfo;->versionCode:I
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->versionName:Ljava/lang/String;
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->sharedUserId:Ljava/lang/String;
    ...
    iput v0, v13, Landroid/content/pm/PackageInfo;->sharedUserLabel:I
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iput v0, v13, Landroid/content/pm/PackageInfo;->installLocation:I
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->overlayTarget:Ljava/lang/String;

    move-wide/from16 v0, p3

    iput-wide v0, v13, Landroid/content/pm/PackageInfo;->firstInstallTime:J

    move-wide/from16 v0, p5

    iput-wide v0, v13, Landroid/content/pm/PackageInfo;->lastUpdateTime:J
    ...
    .local v7, appDir:Ljava/lang/String;
    move-object/from16 v0, p0

    iget-boolean v0, v0, Landroid/content/pm/PackageParser$Package;->mIsSkin:Z
    ...
    iput-boolean v0, v13, Landroid/content/pm/PackageInfo;->isSkin:Z
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->gids:[I
    ...
    new-array v0, v5, [Landroid/content/pm/ConfigurationInfo;

    move-object/from16 v16, v0

    move-object/from16 v0, v16

    iput-object v0, v13, Landroid/content/pm/PackageInfo;->configPreferences:[Landroid/content/pm/ConfigurationInfo;
    ...
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->configPreferences:[Landroid/content/pm/ConfigurationInfo;
    ...
    new-array v0, v5, [Landroid/content/pm/FeatureInfo;

    move-object/from16 v16, v0

    move-object/from16 v0, v16

    iput-object v0, v13, Landroid/content/pm/PackageInfo;->reqFeatures:[Landroid/content/pm/FeatureInfo;
    ...
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->reqFeatures:[Landroid/content/pm/FeatureInfo;
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->activities:[Landroid/content/pm/ActivityInfo;
    ...
    iget-object v0, v6, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Landroid/content/pm/PackageParser;->generateActivityInfo(Landroid/content/pm/PackageParser$Activity;IZII)Landroid/content/pm/ActivityInfo;
    ...
    :cond_8
    new-array v0, v11, [Landroid/content/pm/ActivityInfo;
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->receivers:[Landroid/content/pm/ActivityInfo;
    ...
    new-array v0, v5, [Landroid/content/pm/ServiceInfo;

    move-object/from16 v16, v0

    move-object/from16 v0, v16

    iput-object v0, v13, Landroid/content/pm/PackageInfo;->services:[Landroid/content/pm/ServiceInfo;
    ...
    :cond_f
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->services:[Landroid/content/pm/ServiceInfo;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Landroid/content/pm/PackageParser;->generateServiceInfo(Landroid/content/pm/PackageParser$Service;IZII)Landroid/content/pm/ServiceInfo;
    ...
    :cond_12
    new-array v0, v11, [Landroid/content/pm/ServiceInfo;
    ...
    new-array v0, v5, [Landroid/content/pm/ProviderInfo;

    move-object/from16 v16, v0

    move-object/from16 v0, v16

    iput-object v0, v13, Landroid/content/pm/PackageInfo;->providers:[Landroid/content/pm/ProviderInfo;
    ...
    .local v14, provider:Landroid/content/pm/PackageParser$Provider;
    iget-object v0, v14, Landroid/content/pm/PackageParser$Provider;->info:Landroid/content/pm/ProviderInfo;
    ...
    :cond_14
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->providers:[Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Landroid/content/pm/PackageParser;->generateProviderInfo(Landroid/content/pm/PackageParser$Provider;IZII)Landroid/content/pm/ProviderInfo;
    ...
    .end local v8           #i:I
    .end local v10           #j:I
    .end local v14           #provider:Landroid/content/pm/PackageParser$Provider;
    :cond_15
    const/4 v11, 0x0
    ...
    :cond_17
    new-array v0, v11, [Landroid/content/pm/ProviderInfo;
    ...
    new-array v0, v5, [Landroid/content/pm/InstrumentationInfo;

    move-object/from16 v16, v0

    move-object/from16 v0, v16

    iput-object v0, v13, Landroid/content/pm/PackageInfo;->instrumentation:[Landroid/content/pm/InstrumentationInfo;
    ...
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->instrumentation:[Landroid/content/pm/InstrumentationInfo;
    ...
    new-array v0, v5, [Landroid/content/pm/PermissionInfo;

    move-object/from16 v16, v0

    move-object/from16 v0, v16

    iput-object v0, v13, Landroid/content/pm/PackageInfo;->permissions:[Landroid/content/pm/PermissionInfo;
    ...
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->permissions:[Landroid/content/pm/PermissionInfo;
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->requestedPermissions:[Ljava/lang/String;
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->requestedPermissionsFlags:[I
    ...
    iget-object v0, v13, Landroid/content/pm/PackageInfo;->requestedPermissionsFlags:[I
    ...
    iput-object v0, v13, Landroid/content/pm/PackageInfo;->signatures:[Landroid/content/pm/Signature;
    ...
    .restart local v8       #i:I
    .restart local v10       #j:I
    .restart local v14       #provider:Landroid/content/pm/PackageParser$Provider;
    :cond_20
    move v9, v10
    ...
    .end local v14           #provider:Landroid/content/pm/PackageParser$Provider;
    .restart local v10       #j:I
    .restart local v15       #service:Landroid/content/pm/PackageParser$Service;
    :cond_21
    move v9, v10
...
.method private parsePackage(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .local v44, supportsSmallScreens:I
    const/16 v43, 0x1

    .local v43, supportsNormalScreens:I
    const/16 v42, 0x1

    .local v42, supportsLargeScreens:I
    const/16 v45, 0x1

    .local v45, supportsXLargeScreens:I
    const/16 v38, 0x1

    .local v38, resizeable:I
    const/16 v17, 0x1
    ...
    const-string v5, "<overlay> has more than one target attribute"
    ...
    const-string v5, "<overlay> has more than one priority attribute"
    ...
    const-string v5, "<overlay> priority malformed"
    ...
    const-string v5, "<overlay> runtime attribute defined multiple times"
    ...
    const-string v5, "<overlay> does not specify a priority"
    ...
    .end local v23           #hasParsedRuntime:Z
    .end local v24           #i:I
    :cond_15
    ...
    .local v48, targetVers:I
    const/16 v47, 0x0

    .local v47, targetCode:Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .local v50, val:Landroid/util/TypedValue;
    if-eqz v50, :cond_23
    ...
    .end local v47           #targetCode:Ljava/lang/String;
    .end local v48           #targetVers:I
    .end local v50           #val:Landroid/util/TypedValue;
    :cond_2c
    :goto_7
    invoke-static/range {p2 .. p2}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .restart local v47       #targetCode:Ljava/lang/String;
    .restart local v48       #targetVers:I
    .restart local v50       #val:Landroid/util/TypedValue;
    :cond_2d
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .local v25, implicitPerms:Ljava/lang/StringBuilder;
    const/16 v27, 0x0
    ...
    if-ge v0, v15, :cond_3f

    sget-object v3, Landroid/content/pm/PackageParser;->NEW_PERMISSIONS:[Landroid/content/pm/PackageParser$NewPermissionInfo;

    aget-object v33, v3, v27
    ...
    .local v40, spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .end local v16           #NS:I
    .end local v28           #is:I
    .end local v40           #spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    ...
    .end local v25           #implicitPerms:Ljava/lang/StringBuilder;
    const/16 v3, 0x80
    ...
    .restart local v25       #implicitPerms:Ljava/lang/StringBuilder;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
    ...
    .restart local v40       #spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    :cond_45
    const/16 v26, 0x0
...
.method private static parsePackageLite(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$PackageLite;
    ...
    const-string v9, "package-verifier"
