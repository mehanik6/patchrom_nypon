...
.method private constructor <init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;Lcom/android/internal/telephony/uicc/IccFileHandler;)V
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mLoadOptionalIcon:Z
    ...
    const-string v0, "ro.semc.sim.bip.enabled"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mBIPProxyEnabled:Z
...
.method private processBipCommand(Lcom/android/internal/telephony/cat/AppInterface$CommandType;Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    .locals 2
    .parameter "cmdType"
    .parameter "cmdDet"
    .parameter
    ...
    .prologue
    .local p3, ctlvs:Ljava/util/List;,"Ljava/util/List<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    ...
    invoke-virtual {p1}, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->ordinal()I
    ...
    :pswitch_0
    invoke-direct {p0, p2, p3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processOpenChannel(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    :pswitch_1
    invoke-direct {p0, p2, p3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processCloseChannel(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    :pswitch_2
    invoke-direct {p0, p2, p3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processReceiveData(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    :pswitch_3
    invoke-direct {p0, p2, p3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processSendData(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    :pswitch_4
    invoke-direct {p0, p2}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processGetChannelStatus(Lcom/android/internal/telephony/cat/CommandDetails;)Z
...
.method private processGetChannelStatus(Lcom/android/internal/telephony/cat/CommandDetails;)Z
    .locals 1
    .parameter "cmdDet"
...
.method private processOpenChannel(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    const-string v0, "process OpenChannel"
    ...
    .local v4, itl:Lcom/android/internal/telephony/cat/InterfaceTransportLevel;
    const/4 v6, 0x0

    .local v6, bearerDescription:Lcom/android/internal/telephony/cat/BearerDescription;
    const/4 v5, 0x0

    .local v5, destinationAddress:[B
    const/4 v7, 0x0

    .local v7, networkAccessName:Ljava/lang/String;
    const/4 v8, 0x0
    ...
    iput-boolean v12, v2, Lcom/android/internal/telephony/cat/TextMessage;->responseNeeded:Z
    ...
    const-string v1, "processOpenChannel alpha="
    ...
    :cond_0
    sget-object v0, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->BUFFER_SIZE:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    invoke-static {v10}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveBufferSize(Lcom/android/internal/telephony/cat/ComprehensionTlv;)I
    ...
    .local v11, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    sget-object v0, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->IF_TRANS_LEVEL:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;

    invoke-direct {p0, v0, v11}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->searchForNextTag(Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Ljava/util/Iterator;)Lcom/android/internal/telephony/cat/ComprehensionTlv;

    move-result-object v10

    if-eqz v10, :cond_2

    invoke-static {v10}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveInterfaceTransportLevel(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/InterfaceTransportLevel;

    move-result-object v4

    sget-object v0, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->OTHER_ADDRESS:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    invoke-static {v10}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveOtherAddress(Lcom/android/internal/telephony/cat/ComprehensionTlv;)[B
    ...
    .end local v11           #iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    :cond_1
    new-instance v0, Lcom/android/internal/telephony/cat/ResultException;
    ...
    .restart local v11       #iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    :cond_2
    sget-object v0, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->BEARER_DESC:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    invoke-static {v10}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveBearerDescription(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/BearerDescription;
    ...
    const-string v1, "processOpenChannel bearer: "
    ...
    sget-object v0, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->NETWORK_ACCESS_NAME:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    invoke-static {v10}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveNetworkAccessName(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    invoke-static {v10}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveTextString(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    iget-object v0, v4, Lcom/android/internal/telephony/cat/InterfaceTransportLevel;->protocol:Lcom/android/internal/telephony/cat/InterfaceTransportLevel$TransportProtocol;
    ...
    const-string v1, "processOpenChannel bufSize="
    ...
    iget-object v1, v4, Lcom/android/internal/telephony/cat/InterfaceTransportLevel;->protocol:Lcom/android/internal/telephony/cat/InterfaceTransportLevel$TransportProtocol;
    ...
    iget v1, v4, Lcom/android/internal/telephony/cat/InterfaceTransportLevel;->port:I
...
.method private processSetUpEventList(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    sget-object v6, Lcom/android/internal/telephony/cat/CommandParamsFactory$1;->$SwitchMap$com$android$internal$telephony$cat$SetEventList:[I

    invoke-static {v3}, Lcom/android/internal/telephony/cat/SetEventList;->fromInt(I)Lcom/android/internal/telephony/cat/SetEventList;

    move-result-object v7

    invoke-virtual {v7}, Lcom/android/internal/telephony/cat/SetEventList;->ordinal()I
    ...
    sget-object v2, Lcom/android/internal/telephony/cat/SetEventList;->NO_EVENT:Lcom/android/internal/telephony/cat/SetEventList;

    .local v2, event:Lcom/android/internal/telephony/cat/SetEventList;
    :goto_0
    iget-boolean v6, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mBIPProxyEnabled:Z

    if-eqz v6, :cond_1

    new-instance v6, Lcom/android/internal/telephony/cat/EventListParams;

    invoke-direct {v6, p1, v4, v2}, Lcom/android/internal/telephony/cat/EventListParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;[BLcom/android/internal/telephony/cat/SetEventList;)V

    iput-object v6, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mCmdParams:Lcom/android/internal/telephony/cat/CommandParams;

    .end local v2           #event:Lcom/android/internal/telephony/cat/SetEventList;
    ...
    .restart local v3       #eventValue:I
    .restart local v4       #rawValue:[B
    .restart local v5       #valueIndex:I
    :pswitch_0
    sget-object v2, Lcom/android/internal/telephony/cat/SetEventList;->USER_ACTIVITY_EVENT:Lcom/android/internal/telephony/cat/SetEventList;

    .restart local v2       #event:Lcom/android/internal/telephony/cat/SetEventList;
    goto :goto_0

    .end local v2           #event:Lcom/android/internal/telephony/cat/SetEventList;
    :pswitch_1
    sget-object v2, Lcom/android/internal/telephony/cat/SetEventList;->IDLE_SCREEN_AVAILABLE_EVENT:Lcom/android/internal/telephony/cat/SetEventList;
    ...
    .end local v2           #event:Lcom/android/internal/telephony/cat/SetEventList;
    :pswitch_2
    sget-object v2, Lcom/android/internal/telephony/cat/SetEventList;->LANGUAGE_SELECTION_EVENT:Lcom/android/internal/telephony/cat/SetEventList;
    ...
    :cond_1
    new-instance v6, Lcom/android/internal/telephony/cat/SetEventListParams;

    invoke-direct {v6, p1, v2}, Lcom/android/internal/telephony/cat/SetEventListParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/SetEventList;)V
...
.method private setIcons(Ljava/lang/Object;)Lcom/android/internal/telephony/cat/ResultCode;
    ...
    invoke-virtual {v5, v6}, Lcom/android/internal/telephony/cat/CommandParams;->setIcon(Landroid/graphics/Bitmap;)Z

    iget-boolean v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mLoadOptionalIcon:Z

    if-eqz v5, :cond_0

    iget-object v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mCmdParams:Lcom/android/internal/telephony/cat/CommandParams;

    iput-boolean v7, v5, Lcom/android/internal/telephony/cat/CommandParams;->mLoadOptionalIconFailed:Z

    const/4 v5, 0x0

    iput-boolean v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mLoadOptionalIcon:Z
    ...
    :cond_1
    iget v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mIconLoadState:I
    ...
    .end local p1
    invoke-virtual {v5, p1}, Lcom/android/internal/telephony/cat/CommandParams;->setIcon(Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {v5, v2}, Lcom/android/internal/telephony/cat/CommandParams;->setIcon(Landroid/graphics/Bitmap;)Z
...
.method make(Lcom/android/internal/telephony/cat/BerTlv;)V
    ...
    :pswitch_d
    iget-boolean v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mBIPProxyEnabled:Z

    if-eqz v5, :cond_5

    invoke-direct {p0, v2, v0, v3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processBipCommand(Lcom/android/internal/telephony/cat/AppInterface$CommandType;Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
