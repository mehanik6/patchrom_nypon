...
.method public getEFLinearRecordSize(ILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Lcom/android/internal/telephony/uicc/IccFileHandler;->getEFLinearRecordSize(Ljava/lang/String;ILandroid/os/Message;)V

    return-void
.end method

.method public getEFLinearRecordSize(Ljava/lang/String;ILandroid/os/Message;)V
    .locals 11
    .parameter "efPath"
    .parameter "fileid"
    .parameter "onLoaded"
    ...
    invoke-direct {v1, p2, p3}, Lcom/android/internal/telephony/uicc/IccFileHandler$LoadLinearFixedContext;-><init>(ILandroid/os/Message;)V
...
.method protected getImgIccEFPath(I)Ljava/lang/String;
    .locals 1
    .parameter "efid"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v30, Lcom/android/internal/telephony/uicc/IccIoResult;

    .local v30, result:Lcom/android/internal/telephony/uicc/IccIoResult;
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/telephony/uicc/IccIoResult;->getException()Lcom/android/internal/telephony/uicc/IccException;
    ...
    .end local v30           #result:Lcom/android/internal/telephony/uicc/IccIoResult;
    :catch_0
    move-exception v23
    ...
    .restart local v30       #result:Lcom/android/internal/telephony/uicc/IccIoResult;
    :cond_0
    :try_start_1
    move-object/from16 v0, v30
    ...
    .local v6, sPath:Ljava/lang/String;
    if-lez v26, :cond_f
    ...
    .end local v5           #fileid:I
    .end local v6           #sPath:Ljava/lang/String;
    .end local v9           #size:I
    .end local v21           #ar:Landroid/os/AsyncResult;
    .end local v22           #data:[B
    .end local v24           #iccException:Lcom/android/internal/telephony/uicc/IccException;
    .end local v26           #path:I
    .end local v30           #result:Lcom/android/internal/telephony/uicc/IccIoResult;
    :pswitch_5
    move-object/from16 v0, p1
...
.method public loadEFImgLinearFixed(ILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/uicc/IccFileHandler;->getImgIccEFPath(I)Ljava/lang/String;
...
.method public loadEFImgTransparent(IIIILandroid/os/Message;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccFileHandler;->getImgIccEFPath(I)Ljava/lang/String;
...
.method public loadEFTransparent(Ljava/lang/String;ILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v2, v0, v14, v1}, Lcom/android/internal/telephony/uicc/IccFileHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loge(Ljava/lang/String;)V

    new-instance v2, Ljava/lang/RuntimeException;

    const-string v3, "efPath is not numeric"
